...
namespace XamlNodes.Core.Pins
{
	...
	public sealed class XamlNodeInputPin : XamlNodePin
	{
		...
		{
			ValuePropertyKey = DependencyProperty.RegisterReadOnly("ValueI", typeof(object), typeof(XamlNodeInputPin), new FrameworkPropertyMetadata(0));
		...
		{
			return new InputAttribute(this.PinName);
		}
